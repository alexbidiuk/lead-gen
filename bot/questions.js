...
const questions = [
  ...
  {
    title:'Введите Ваш телефон в формате +380 или 380. На него будут высланы результаты теста: ',
    userField: 'phone',
    type: 'open'
  },
  {
    title:'Напишите Ваш город: ',
    userField: 'city',
    type: 'open'
  },
  {
    title:'Вопрос (1/25): «Откуда вы берете информацию для настройки таргетинга ?» \n \n' +
  ...
  {
    title:'Вопрос (2/25): «Легко ли вы обучаетесь новому:» \n \n' +
  ...
  {
    title:'Вопрос (3/25): «Клиент говорит, что у вас ошибки в таргетинге. Ваши действия ?» \n \n' +
  ...
  {
    title:'Вопрос (4/25): «Готовы ли вы признавать свои ошибки?» \n \n' +
  ...
  {
    title:'Вопрос (5/25): «Вы получили техническое задание на настройку рекламы.\n' +
  ...
  {
    title:'Вопрос (6/25): «Где находится база лидов, которые были собраны через лид форму?» \n \n' +
    ...
    title:'Вопрос (7/25): «На каком уровне аккаунта находится выбор плейсментов для размещения рекламы?» \n \n' +
    ...
    title:'Вопрос (8/25): «Какую индивидуализированную аудиторию нельзя создать?» \n \n' +
    ...
    title:'Вопрос (9/25): «На каком уровне аккаунта можно задавать цели рекламы на Facebook?» \n \n' +
      '1. Только на уровне кампаний \n' +
    ...
    title:'Вопрос (10/25): «Какую цель рекламной кампании необходимо выбрать для сбора лидов на лид форму?» \n \n' +
      '1. Цель “Конверсии” \n' +
    ...
    title:'Вопрос (11/25): «Какие дополнительные рекламные цели кампании важны, если Вы хотите чтобы о Вашей компании узнало, как можно больше людей?» \n \n' +
      '1. Конверсии \n' +
    ...
    title:'Вопрос (12/25): «Какую цель рекламной кампании необходимо выбрать для сбора регистраций на лендинге?» \n \n' +
      '1. Цель “Конверсии” \n' +
      '2. Цель “Вовлеченность” \n' +
      '3. Цель “Генерация лидов” \n' +
      '4. Цель “Трафик” \n',
    ...
    title:'Вопрос (13/25): «Выберите максимальный размер Lookalike аудитории от общего населения страны, предлагаемый стандартными средствами Фейсбук» \n \n' +
      '1. 1% \n' +
      '2. 5% \n' +
      '3. 10% \n' +
      '4. 15% \n',
    ...
    title:'Вопрос (14/25): «Какой показатель отвечает за стоимость 1000 показов рекламного объявления?» \n \n' +
      '1. CPA \n' +
      '2. CPC \n' +
      '3. CTR \n' +
      '4. CPM \n',
    ...
    title:'Вопрос (15/25): «Какое максимальное допустимое  количество объявлений в рекламном кабинете?» \n \n' +
      '1. 3500 \n' +
      '2. 3000 \n' +
      '3. 4500 \n' +
      '4. 6000 \n',
  ...
  {
    title:'Вопрос (16/25): «Сколько карточек можно разместить в формате показа рекламы “кольцевая галерея”?» \n \n' +
      '1. До 4 шт. \n' +
      '2. До 6 шт. \n' +
      '3. До 10 шт. \n' +
      '4. До 5 шт. \n',
    ...
    title:'Вопрос (17/25): «Какой на ваш взгляд блок в тексте рекламы самый важный?» \n \n' +
    ...
    title:'Вопрос (18/25): «Сколько % текста разрешено размещать на изображении - рекламном баннере в Instagram?» \n \n' +
      '1. 30% \n' +
      '2. 10% \n' +
      '3. 20% \n' +
      '4. 15% \n',
    ...
    title:'Вопрос (19/25): «Сколько времени может длиться реклама в Instagram Stories?» \n \n' +
      '1. до 15 сек \n' +
      '2. до 30 сек \n' +
      '3. до 1 мин \n' +
      '4. до 2 мин \n',
    ...
    title:'Вопрос (20/25): «В рекламе за конверсии, какую из страниц нужно указать в качестве страницы совершения конверсии?» \n \n' +
    ...
    title:'Вопрос (21/25): «Куда нужно установить код facebook pixel на странице?» \n \n' +
      '1. <head> \n' +
      '2. <body> \n' +
    ...
    title:'Вопрос (22/25): «Настроем сплит-тест в Google Analytics. Тестируются 3 лендинга.\n' +
    ...
    title:'Вопрос (23/25): «Сколько дней рекомендовано проводить сплит-тестирование лендингов?» \n \n' +
      '1. 3 дня \n' +
      '2. 5 дней \n' +
      '3. 7 дней \n' +
      '4. 1 месяц \n',
    ...
    title:'Вопрос (24/25): «Укажите несуществующую переменную в UTM - метках» \n \n' +
      '1. utm - source \n' +
      '2. utm-term \n' +
      '3. utm-content \n' +
      '4. utm-special \n',
    ...
    title:'Вопрос (25/25): «Сколько utm меток может распознать Google Analytics?» \n \n' +
      '1. 3 \n' +
      '2. 4 \n' +
      '3. 5 \n' +
      '4. 6 \n',

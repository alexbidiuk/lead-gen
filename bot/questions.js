const questions = [
  ...
  },
  {
    ...
    vars: [
      ...
      [{ text: 'страница на которой установлен Facebook Pixel', callback_data: '22_0' }],
      [{ text: 'страница благодарности - показывается после страницы на которую льется трафик', callback_data: '22_4' }],
      [{ text: 'Страница на которой, после проверки, Facebook Fixel Helper - горит зеленым цветом', callback_data: '22_0' }]
    ],
    type: 'vars',
  },{

  ...
  const getFinalText = (total) => {
    ...
    if (0 <= total && total <= 49) {
      text = text + "*Все плохо.*\n" +
        ...
        "[Участвовать](https://leadgen.studio/mk_lp1/)"
    } else if (50 <= total && total <= 69) {
      text = text + "*Неплохой результат.*\n \n" +
        `*Набрано баллов: ${total} из 100* \n \n` +
        "*Что это значит: * \n" +
        ...
        "Тестирование спроса/Запуск Воронки продаж/Трафик и масштабирование.\n" +
        "Кликайте по кнопке ниже, чтобы узнать детали встречи и забронировать участие.\n\n" +
        "[Участвовать](https://bit.ly/300EO1f)"
    } else if (70 <= total && total <= 80) {
      text = text + "*Хороший результат, и вы можете лучше!*\n \n" +
        `*Набрано баллов: ${total} из 100* \n \n` +
        "*Что это значит: * \n" +
        ...
        "Тестирование спроса/Запуск Воронки продаж/Трафик и масштабирование.\n" +
        "Кликайте по кнопке ниже, чтобы узнать детали встречи и забронировать участие.\n\n" +
        "[Участвовать](tg://resolve?domain=Leadgenstudio)"
